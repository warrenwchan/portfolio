                  ...
                  <div className="flex flex-row gap-x-4">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex flex-row gap-4 justify-between items-start">
                        ...
                        <button className="pl-6 pr-3 py-2 text-xs font-medium bg-slate-100 group-hover:bg-slate-200/50 transition-all ease-out duration-200 rounded-full flex flex-row items-center gap-x-1">View <FontAwesomeIcon icon={faArrowRight} className="scale-75 transition transform opacity-0 -translate-x-4 group-hover:-translate-x-0 group-hover:opacity-100" /></button>
                      </div>
                    </div>
                  </div>
                </Link>
